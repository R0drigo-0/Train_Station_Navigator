...
class TestCases(unittest.TestCase):
    ...
    def setUp(self):
        ...
        info_velocity_clean = read_information(
    ...
    def test_Expand(self):
        ...
        self.assertEqual(
            expanded_paths, [Path([13, 12, 8]), Path([13, 12, 11]), Path([13, 12, 13])]
        )
    ...
    def test_calculate_cost(self):
        ...
        self.assertEqual(
            [path.g for path in updated_paths], [59.000060000000005, 84.52346]
        )
    ...
    def test_calculate_heuristics(self):
        ...
        self.assertEqual(
            [path.h for path in updated_paths],
    ...
    def test_remove_redundant_path(self):
        ...
        expand_paths = [
            create_path_with_cost_g([12, 8, 7, 11], 124.52),
    ...
    def test_Astar(self):
        ...
        # print(optimal_path.route, optimal_path.f)
        self.assertTrue(
            optimal_path == Path([3, 2, 10, 11, 12, 13, 14])
            or optimal_path == Path([3, 2, 5, 6, 7, 8, 13, 14])
        )
